...
'''
  ...
  environment {
    ...
    imageAPIDevName='orderbookapi-dev-'
    imageAPIProdName='orderbookapi-prod-'
    imageDBDevName='orderbookdb-dev-'
    imageDBProdName='orderbookdb-prod-'
    imageACDevName='orderbookac-dev-'
    imageACProdName='orderbookac-prod-'
    projectName='orderbook'
  }
}
